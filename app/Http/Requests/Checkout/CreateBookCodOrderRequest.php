...
class CreateBookCodOrderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'formatType' => ['nullable', Rule::in(['hardcopy'])],
    ...
    {
        $this->merge([
            'formatType' => $this->input('formatType') ?: 'hardcopy',
